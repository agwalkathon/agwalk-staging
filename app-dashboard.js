  ...
  async function applyDynamicDashboard(){
    ...
    function renderWhoopTextLogo() {
      if (logoWrap) {
        ...
        txtEl.style.cssText = "font-family:var(--font); font-size:22px; font-weight:300; color:#ffffff; text-align:center; text-transform:uppercase; letter-spacing:5px; opacity:0.95;";
